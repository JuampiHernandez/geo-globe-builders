...
export interface CountryStats {
  ...
  countryCode: string;
  builderCount: number;
  rankScore: number; // Country score based on builder ranks (higher = better)
  rankedBuilders: number; // Number of builders in global top 100
  topBuilders: Array<{
    name: string;
    rank: number | null;
    score: number;
...
// Country coordinates for globe markers
export const COUNTRY_COORDINATES: Record<string, { lat: number; lng: number }> = {
  ...
  MK: { lat: 41.512415, lng: 21.745275 },
